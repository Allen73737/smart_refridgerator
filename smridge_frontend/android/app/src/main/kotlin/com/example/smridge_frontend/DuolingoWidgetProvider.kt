        ...
        for (appWidgetId in appWidgetIds) {
            try {
                val views = RemoteViews(context.packageName, R.layout.widget_duolingo).apply {
                    ...
                    setTextViewText(R.id.freshness_value, "FRESH SCORE: $freshness")
                    setTextViewText(R.id.door_value, "DOOR IS $door")
                    setTextViewText(R.id.status_text, status.replace("PROTOCOL: ", "CURRENT: "))
